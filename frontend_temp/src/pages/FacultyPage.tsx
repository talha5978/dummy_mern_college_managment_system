...
import { useGetTeachersQuery, useLazyGetStudentQuery } from '../services/users.api';
...
import { closeDialoge, openDialog, setStudentDialogeData, setTeachersPagination, stateDialogeBoxes } from '../store/uiSlice';
...
function DataTableViewOptions({ table, disabled, dispatch }: DataTableViewOptionsProps<TeacherType>) {
    ...
    return (
        <div className="flex gap-2">
            ...
            >
                <PlusIcon />
                <span className="hidden md:inline">Add Faculty Member</span>
            </Button>
            <DropdownMenu>
                ...
                <div>
                    <div
                        ...
                        onClick={() => {
                            ...
                            toast.success("Faculty Member id copied", {
					...
					<>
						<DropdownMenu>
							...
							<DropdownMenuContent align="end">
								...
								>
									Update
                                    {isFetchingTeachers && <SpinnerLoader />}
								</DropdownMenuItem>
							</DropdownMenuContent>
						</DropdownMenu>
					</>
